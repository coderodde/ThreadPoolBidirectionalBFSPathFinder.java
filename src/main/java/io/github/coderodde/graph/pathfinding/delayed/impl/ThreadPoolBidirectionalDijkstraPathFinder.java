 ...
 */
public final class ThreadPoolBidirectionalDijkstraPathFinder<N> 
extends AbstractDelayedGraphPathFinder<N> {
    
    /**
     * 
     */
    private static final Map<ThreadPoolBidirectionalDijkstraPathFinder,
    ...
    private static final Logger LOGGER = 
            Logger.getLogger(
                    ThreadPoolBidirectionalDijkstraPathFinder
                            .class
                            .getSimpleName());
     ...
     */
    public ThreadPoolBidirectionalDijkstraPathFinder(
     ...
     */
    public  ThreadPoolBidirectionalDijkstraPathFinder(final int numberOfThreads) {
